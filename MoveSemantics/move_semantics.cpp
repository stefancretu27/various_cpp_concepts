...
int main()
{
	...
	cout<<"     the class implementation doesn't involve an explicit definition for either of the following: copy semantics, destructor, constructor."<<endl;
    	cout<<"     Usually, the implementation involves assigning/passing/moving the resources from the argument object to the newly created or assigned to object. This means the object received as argument "<<endl;
