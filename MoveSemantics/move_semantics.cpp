...
int main()
{
	...
	cout<<"     1. Move semantics is implicitly geenrated if all non-static members and all base classes have move semantics implemented or are trivially movable and when d-tor and"<<endl;
	cout<<"	    copy semantics are implicitly generated (no user provided implementations for them). Otherwise,copy semantics must be implemented. Their implementation involves assigning/passing/moving"<<endl;
