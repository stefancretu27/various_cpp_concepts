...
class MoreBottom: public Bottom
{
    public:
    MoreBottom() = default;
    virtual void printName() override final{std::cout<<"MoreBottom"<<std::endl;};
    //override method from 2nd Base class
    void printEuler() override final {std::cout<<"Negative Euler: "<<euler*(2)<<std::endl;};
    //does not override as it is virtual and the inherited one is non-virtual
    void printString() override final {std::cout<<"string"<<std::endl;}; 
